  ...
  const retroChrome = (
    <>
      ...
      <div style={{
        ...
        <a href="https://github.com/salaboy/observing-ai/tree/main/java/spring-ai-with-arconia/spring-merch-store-arconia-openlit">Spring Merch Store (Spring AI Arconia OpenLit SemConv)</a>
