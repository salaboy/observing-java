...
export default function App() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: 'Welcome to the Python Merch Store! Here you can order merch from different Python projects. Ask me about t-shirts, socks, or stickers for any Python project.',
    },
  ])
    ...
    <>
      ...
      <div style={{ background: '#000080', padding: '8px 0', flexShrink: 0, overflow: 'hidden' }}>
        <div style={{
          ...
          <span>✦</span><span>★ PYTHON MERCH STORE ★</span><span>✦</span>
        </div>
