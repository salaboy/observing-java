...
export default function App() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: 'Welcome to the Crew AI Merch Store! Here you can order merch from different Python projects. Ask me about t-shirts, socks, or stickers for any Python project.',
    },
  ])
  ...
  const retroChrome = (
    <>
      ...
      <div style={{
        ...
        <a href="https://github.com/salaboy/observing-ai/tree/main/python/crew-ai/">Crew AI Merch Store</a>
      ...
      <div style={{
        ...
        <div style={{
          ...
          http://www.python-merch-store.com/shop/index.html
        </div>
        <div style={{
          border: '2px solid', borderColor: '#ffffff #808080 #808080 #ffffff',
      ...
      <div style={{ background: '#000080', padding: '8px 0', flexShrink: 0, overflow: 'hidden' }}>
        <div style={{
          ...
          <span>✦</span><span>★ CREW AI MERCH STORE ★</span><span>✦</span>
        </div>
        <div style={{ color: '#00ff00', fontSize: '11px', marginTop: '4px', textAlign: 'center' }}>
          🔥 HOT DEALS ON PYTHON PROJECTS MERCH 🔥 &nbsp;&nbsp; ⭐ FREE SHIPPING ON ORDERS OVER $50 ⭐
        </div>
  ...
  const inputArea = isRetro ? (
    ...
    <div style={{
      ...
      <input
        ...
        onChange={e => setInput(e.target.value)}
        onKeyDown={handleKeyDown}
        placeholder="Ask about Python merch..."
        disabled={loading}
        style={{
    ...
    <div style={{
      ...
      {isRetro && (
        <div style={{
          ...
          <span>{loading ? '⏳ Connecting to PythonBot server...' : '✅ Done'}</span>
